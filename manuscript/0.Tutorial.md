...
An action can also be spent to help with a maneuver. To do so, the player describes how his character helps another character or how he used knowledge from another field of expertise to help himself. The helper rolls a single Competence die against the difficulty of the task. If the roll is successful, add a success to the character making the maneuver. A character can receive any amount of extra success, but cannot have more successes than his competence level.
...
**Incapacitate:** For each success spend to incapacitate an opponent, you roll a success die and pick the highest one. The defender then subtract the result from their hit points pool. The success die is determined by your opponent armor type. 
...
| |
| *Disengage:* You can break your engagement against one opponent | 
...
The combat takes place in an old barn and the characters have interest in taking advantage of the battlefield features.
...
| Blod drain    | Success  | On a Talon attack that reduced Health, the styrge regain the same number of Health than its opponent have lost. |
| Death stench  | Trigger  | When an opponent engage a styrge, the styrge make a free scuffle attack against the opponent. If the attack is successful, the opponent is at disadvantage for as long as he stay engage with the styrge.                      |
...
| Abilities     |          |                                                                                                        |
| ------------- | -------- | ------------------------------------------------------------------------------------------------------ |
| Shreik        | Weapon   | Missile, Ignore armor, Weak (Base damage 1d4).                                                |
| Talons        | Weapon   | Hand-to-Hand.                                                                                 |
...
| Abilities     |          |                                                                                                                        |
| ------------- | -------- | ---------------------------------------------------------------------------------------------------------------------- |
| Talons        | Weapon   | Hand-to-Hand, Grab.                                                                                           |
...
> *As you reach Amun, you hear screams of panic in the street of the city. A chill go down your spine as you remember what happen tomorrow to your friends and family. There is no used going into the city, unless you want to die. Yarim looks at you with a tear in his eyes. "Let's move", he says. "There will be nothing left of Amun in a few hours."*
