...
Thus, the Naga fall prey to the hunt of the Rakshasa demons. The Tengu had been cursed by the Oni losing their ability to use their wing to fly. Even the mighty Jinn that has mastered terrible magic had their nation collapse before the Ghül invasion.
...
This adventure is designed for 2 to 7 players, but ideally the sweet spot is to have around 4 or 5 players. One of the players will take the mantle of the storyteller and will direct the adventure while the other players will choose a character to play in appendix A.

This section broadly describes the basic elements of the game: adventures, characters and rules.
...
More experienced storyteller should feel free the change names, locations or descriptions that fit more their style. Remember that an adventure is only a framework and if the storyteller, or any players, have an idea that is more fun than what is described here, feel free to adapt the framework to tell the story you want.

## Player Characters

Characters are described by many aspects that have different purposes in the game. These aspects are competences, resources and resistances.
...
- Resources are points that can be spent to gain a benefit or lost when failing a challenge.
- Resistances determine how difficult it is for other characters to affect the player with one of their actions.

### Non-player's characters

The beginning of the adventure introduce Yarim the guard captain that helps the character escape the raid. Yarim is what is called a Non-player’s character, i.e. a character that is controlled uniquely by the storyteller.

Yarim is the storyteller tool to give the story a direction and gives characters clues about what to do next. Yarim should not be used to resolve challenge, but will give advice to the characters and help them only if needed.
...
In the barn, there should be a demon per two characters starting with a Harpy and Rakshasa demons afterward.
...
In order to act in the offensive phase, a character must have Initiative. At the start of the combat, every player rolls a Military maneuver to assess the battlefield. Each success allows the character to either gain Initiative, gain an extra action or gain an extra position point. Character that did not gain initiative can only act in the reactive phase. During the defensive phase, the opponents make their move against the characters.
...
A battlefield can have multiple vantage points that give a benefit to a combatant that take advantage of it. To gain the benefits of a vantage point, the player must spend a position point to occupy it. As long as that character occupies the vantage point, no other character can use it.
...
A character can be removed from a vantage point from an attack that trick him out of position.
...
Range attack does not require to be engaged with an opponent and work best when the target is not engaged since range attacks are reduced by 1 dice per opponent engaged with the target.
...
The success die is determined by your weapon type and by whether you have advantage or disadvantage on damage. Advantage increase by one step the success die while disadvantage reduce it by one step. Advantage is gained if your weapon grade is higher than your opponent armor grade. Damage is at a disadvantage against armored opponents.
...
Even if it's opponents turn, characters can be active by hindering an attack or defending against an attack.
...
**Dodge**: Then defender takes a step to avoid a melee attack or a thrown weapon. The expertise of a dodge is determined by the Acrobatics competence.

**Parry**: The defender use his melee weapon to deflect or block an attacker melee attack. The expertise of a parry is determined by the grade of the weapon.
...
|             |               |               |       |              |       |
| ----------- | ------------- | ------------- | :---: | ------------ | :---: |
| Challenge 1 | Hiding        | Dissimulation | 1d6/6 |              |       |
| Challenge 2 | Cold          | Start a fire  | 3d6/4 | Find Shelter | 1d6/6 |
|             | Hunger        | Hunting       | 2d6/6 | Gathering    | 1d6/6 |
|             | Weariness     | Build camp    | 3d6/5 | Find Shelter | 1d6/6 |
| Challenge 3 | Liddle forest | Trail         | 2d6/4 | Forest       | 2d6/6 |
|             | Usha river    | Main bridge   | 1d6/6 | Ford         | 1d6/6 | Build bridge | 3d6/4 |
|             | Amun plain    | Walking       | 3d6/4 | Jogging      | 3d6/4 | Running      | 3d6/5 |

| Challenge 4 | Damage | Combat | Daunt | Feint | Scuffle | Trick |
| ----------- | :----: | :----: | :---: | :---: | :-----: | :---: |
...
Belur has used his saving to set up a small shop in Amun where he can sell the weapon and armor that he crafts in the hope to retire from a soldier’s life.
...
|             |               |               |       |              |       |
| ----------- | ------------- | ------------- | :---: | ------------ | :---: |
| Challenge 1 | Hiding        | Dissimulation | 0d6/6 |              |       |
| Challenge 2 | Cold          | Start a fire  | 3d6/4 | Find Shelter | 2d6/6 |
|             | Hunger        | Hunting       | 1d6/6 | Gathering    | 2d6/6 |
|             | Weariness     | Build camp    | 3d6/5 | Find Shelter | 2d6/5 |
| Challenge 3 | Liddle forest | Trail         | 2d6/4 | Forest       | 2d6/6 |
|             | Usha river    | Main bridge   | 0d6/6 | Ford         | 1d6/6 | Build bridge | 3d6/4 |
|             | Amun plain    | Walking       | 3d6/4 | Jogging      | 3d6/4 | Running      | 3d6/5 |
...
| *Fighting*    |       |               |       |            |       |               |       |            |       |
| Combat        |  2/2  | Daunt         |  3/3  | Feint      |  1/2  | Scuffle       |  1/-  | Trick      |  1/1  |
...
|             | Hunger        | Hunting       | 0d6/6 | Gathering    | 1d6/6 |
|             | Weariness     | Build camp    | 1d6/6 | Find Shelter | 1d6/6 |
| Challenge 3 | Liddle forest | Trail         | 3d6/4 | Forest       | 3d6/5 |
|             | Usha river    | Main bridge   | 1d6/6 | Ford         | 1d6/6 | Build bridge | 1d6/6 |
|             | Amun plain    | Walking       | 1d6/5 | Jogging      | 1d6/6 | Running      | 1d6/6 |

| Challenge 4 | Damage | Combat | Daunt | Feint | Scuffle | Trick |
| ----------- | :----: | :----: | :---: | :---: | :-----: | :---: |
| Harpy       |   1d8  | 2d6/6  | 3d6/5 | 1d6/6 |  1d6/4  | 1d6/4 |
| Goat        |   1d4  | 2d6/4  | 3d6/5 | 1d6/6 |  1d6/6  | 1d6/6 |
| Feline      |   1d6  | 2d6/5  | 3d6/4 | 1d6/6 |  1d6/4  | 1d6/6 |
...
|             |               |               |           |              |       |
| ----------- | ------------- | ------------- | :-------: | ------------ | :---: |
| Challenge 1 | Hiding        | Dissimulation | 3d6/4[^1] |              |       |
| Challenge 2 | Cold          | Start a fire  | 2d6/5     | Find Shelter | 3d6/5 |
|             | Hunger        | Hunting       | 3d6/4     | Gathering    | 3d6/5 |
|             | Weariness     | Build camp    | 2d6/6     | Find Shelter | 3d6/4 |
| Challenge 3 | Liddle forest | Trail         | 3d6/4     | Forest       | 3d6/5 |
|             | Usha river    | Main bridge   | 2d6/6     | Ford         | 2d6/5 | Build bridge | 2d6/5 |
|             | Amun plain    | Walking       | 1d6/5     | Jogging      | 1d6/6 | Running      | 1d6/6 |
...
| Challenge 4 | Damage | Combat | Daunt | Feint | Scuffle | Trick |
| ----------- | :----: | :----: | :---: | :---: | :-----: | :---: |
| Harpy       |  1d10  | 2d6/6  | 1d6/6 | 2d6/6 |  1d6/4  | 2d6/4 |
| Goat        |  1d6   | 2d6/5  | 1d6/6 | 2d6/6 |  1d6/4  | 2d6/6 |
| Feline      |  1d8   | 2d6/6  | 1d6/5 | 2d6/6 |  1d6/4  | 2d6/6 |
...
| Challenge 2 | Cold          | Start a fire  | 3d6/4 | Find Shelter | 3d6/5 |
|             | Hunger        | Hunting       | 1d6/6 | Gathering    | 3d6/5 |
|             | Weariness     | Build camp    | 3d6/5 | Find Shelter | 3d6/4 |
| Challenge 3 | Liddle forest | Trail         | 0d6/6 | Forest       | 0d6/6 |
|             | Usha river    | Main bridge   | 3d6/6 | Ford         | 3d6/4 | Build bridge | 3d6/4 |
|             | Amun plain    | Walking       | 2d6/4 | Jogging      | 2d6/5 | Running      | 1d6/6 |
...
When the Human capital fall last year, she moves to Amun where life was kinder to her. She even met Joacquim, a farmer from Liddle Village that hire her to work on his farm. Now that Joacquim is dead, she will probably end back on the streets of Amun.
