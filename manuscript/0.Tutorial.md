...
Ogres is a game where players collaboratively build the tale of heroes trying to survive in a world that has fallen to demons. One player, called the storyteller, will be responsible for defining the global framework of a story in which each players will tell the tale of an individual hero with their own personality and capabilities.

Some story have a predefine ending determine at the start of the game, but most story are open ended. When the characters reach the goal they have set for their group, they find a new one to fulfill. Story can take a single game session to tell, but most of the time it will take more than one gaming session mimicking chapters or scene of traditional storytelling.
