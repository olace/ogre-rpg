...
The character sheet describing each each character is split into six sections. 

1. The description section explains the background of the character and their motivations.
2. The character resources can be spent to gain a benefit or lost when failing a challenge. If there are two numbers, the first one represents the long term pool which is replenished slowly and the second number the short term pool which is replenished rapidly.
...
6. Special abilities of a characters. The first ability listed comes from the character equipment while the last one represents ability of the character developed by their training.

{pagebreak}

## Aminah the ascetic Jinn

Aminha has been raised in the desert as a protector for the Sand navigator, a group of recluse nomads seeking deep understanding of the great sea of sands. As a protector, Aminha has learned the secret of the stone fist which allows her to transform her fist into stone making them deadly weapons.
...
| ------------- | :---: | ------------- | :---: | ---------- | :---: | ------------- | :---: | ---------- | :---: |
| *Resources*   |       |               |       |            |       |               |       |            |       |
| Hit Points    |  9/7  | Energy Points |  4/5  | Position   |   3   |               |       |            |       |
| *Competences* |       |               |       |            |       |               |       |            |       |
...
| Abilities                  |          |                                                                                    |
| -------------------------- | -------- | ---------------------------------------------------------------------------------- |
| Fist of stone              | Weapon   | Hand-to-hand, grade 0, natural.                                                    |
| Wind of the desert stance  | Position | When in this stance Aminah can use her stone fist (grade 2) to parry weapons.      |
| Storm of the desert stance | Position | Instead of taking the highest Success die when determining damage, Aminah can add Success dice together instead.   |

{pagebreak}

## Belur the Dvegar merchant

Belur left the mountains during the Troll invasion to take refuge with the human. Since then, he has been an axe for hire to gain his keep and have worked for many different groups in different regions of the world. Yarim has hired him two years ago as a guard and Belur could settle down in a single place and have a regular income.
...
| ------------- | :---: | ------------- | :---: | ---------- | :---: | ------------- | :---: | ---------- | :---: |
| *Resources*   |       |               |       |            |       |               |       |            |       |
| Hit Points    |  9/7  | Energy Points |  7/4  | Position   |   1   |               |       |            |       |
| *Competences* |       |               |       |            |       |               |       |            |       |
...
| Armor         |  1d4  | Block         |   3   | Parry      |   3   | Dodge         |   1   |            |       |

| Abilities    |         |                                                                                                |
| ------------ | ------- | ---------------------------------------------------------------------------------------------- |
| Battle axe   | Weapon  | Melee, Grade 3, Reach.                                                                         |
| Mail         | Armor   | Medium, Grade 3.                                                                               |
...
| ------------- | :---: | ------------- | :---: | ---------- | :---: | ------------- | :---: | ---------- | :---: |
| *Resources*   |       |               |       |            |       |               |       |            |       |
| Hit Points    |  4/6  | Energy Points |  9/7  | Position   |   2   |               |       |            |       |
| *Competences* |       |               |       |            |       |               |       |            |       |
...
| Armor         |  1d8  | Block         |   -   | Parry      |   3   | Dodge         |   1   |            |       |

| Abilities           |           |                                                                                         |
| ------------------- | --------- | --------------------------------------------------------------------------------------- |
| Sword               | Weapon    | Melee, Grade 2, Parry.                                                                  |
| Cuir Bouilli        | Armor     | Light Armor, grade 1.                                                                   |
| Defensive formation | Position  | Create a battle formation with up to 2 allies who must spend a position point to join the formation. While in formation, any character can spend an action to transfer up to 3 defense points to another member of the formation.       |
...
| ------------- | :---: | ------------- | :---: | ---------- | :---: | ------------- | :---: | ---------- | :---: |
| *Resources*   |       |               |       |            |       |               |       |            |       |
| Hit Points    |  6/6  | Energy Points |  4/7  | Position   |   5   |               |       |            |       |
| *Competences* |       |               |       |            |       |               |       |            |       |
...
| Abilities       |          |                                                                                         |
| --------------- | -------- | --------------------------------------------------------------------------------------- |
| Staff           | Weapon   | Melee, grade 1, double, 2 handed.                                                       |
...
The three Isamu brothers had a promising military career being in one of the best divisions of the Tengu army. When the curse has been cast on the Tengu, the Military force fell in chaos and their career stop abruptly. Since they were no more Tengu army, Karasu and his brothers move to serve in the army of the other races to advance their military position. Their last affectation was with the human military and they were stationed at Amun. Karasu has just been dispatched to Liddle Village while his brother remains in Amun. It was just supposed to be a routine affectation, but the Ogres attack change everything.

| Karasu        |       |               |       |            |       |               |       |            |       |
| ------------- | :---: | ------------- | :---: | ---------- | :---: | ------------- | :---: | ---------- | :---: |
| *Resources*   |       |               |       |            |       |               |       |            |       |
| Hit Points    |  4/8  | Energy Points |  3/8  | Position   |   5   |               |       |            |       |
| *Competences* |       |               |       |            |       |               |       |            |       |
...
| ------------- | :---: | ------------- | :---: | ---------- | :---: | ------------- | :---: | ---------- | :---: |
| *Resources*   |       |               |       |            |       |               |       |            |       |
| Hit Points    |  3/7  | Energy Points |  7/8  | Position   |   3   |               |       |            |       |
| *Competences* |       |               |       |            |       |               |       |            |       |
...
| Abilities   |         |                                                                                         |
| ----------- | ------- | --------------------------------------------------------------------------------------- |
| Dagger   x2 | Weapon  | Hand-to-hand, Thrown, Grade 1.                                                          |
...
If the players have succeeded at the first challenge, Yarim will receive one action to aid any other character on their maneuver, but if they failed the first maneuver, Yarim is too wounded to do anything except some talking.
...
An action can also be spent to help with a maneuver. To do so, the player describes how his character helps another character or how he used knowledge from another field of expertise to help himself. The helper roll a single Competence die against the difficulty of the task. If the roll is successful, add a success to the character making the maneuver. A character can receive any amount of extra success, but cannot have more successes than his competence level.

### Energy

Each character has a pool of Energy from which the player can spend points to either increase the number of successes of a maneuver or making extra actions. Energy is split into two pools: Fatigue and Exhaustion.
...
There is no limit to the number of actions a character can make, but each action must be used for a different purpose. For example, a player cannot use two actions to help with the same maneuver.
...
The attack happens before supper and characters are starving. If the storyteller chooses this threat, the character must find food themselves in the forest. If the storyteller do not choose this threat, Yarim have bread and cheese in his backpack and his happy to share it with everybody.
...
### Multiple rounds
Since this challenge requires many maneuvers, it will be split into multiple rounds. Each round, character receives a maneuver and an action. When all character has acted, a new round begins and each character receives another maneuver and action. Actions not spent in a round can be used in further rounds, but maneuvers that are not used are automatically converted into an extra action.
...
> *As you approach Amun, you hear monstrous screams in the sky. As you look up, you see a flock of harpies plunge toward your group. Fortunately, there is an old barn nearby where you can take shelter. As you close the door behind you, you notice that the old barn wasn't a shelter, but a trap. There is an hole in the roof where [1 per 2 characters] harpies are already entering the barn.*
...
At the start of the combat, every player rolls a Military maneuver to assess the battlefield. Each success allows the character to either gain an extra action, gain an extra position point or gain Initiative. Gaining initiative allows a character to act in the offensive phase of a round and fight at an optimum reach in close combat.

### Player's turn (Offensive and reactive phase)

Like any multi-round challenge, each player receives at the start of a round one action and one maneuver. Actions can be spent to manipulate a piece of equipment or any object on the battlefield. They can also be used to help another character make an offensive maneuver.
...
A battlefield can have multiple vantage points that give a benefit to a combatant that take advantage of it. To gain the benefits of a vantage point, the player must spend a position point to occupy it. As long as that character occupies the vantage point, no other character can use it. A character can be removed from a vantage point with a Tactics attack.
...
**Incapacitate:** For each success spend to incapacitate an opponent, you roll a success die and pick the highest one. The defender then subtract the result from their hit points pool. The success die is determined by your opponent armor type. If your weapon grade is higher than the opponent armor grade, treat the armor as one category lower.
...
**Combat effect:** Instead of rolling a success die, an attacker may choose a combat effect depending on the maneuver. An attacker that spends all his success die on combat effect does not deal damage to the defender.

| Combat (Difficulty: Opponent's Reflex, Success: Defender armor) |
| --- |
| A Combat maneuvers consists of quick attacks, parries and ripostes to find an opening in the opponent defense for your strike. When using combat maneuvers, a character tries to maximize the effectiveness of his attack. |
| |
...
| *Pin:* Foe cannot use sword or shield (attacker choice) to defend until it's next turn. |

| Daunt (Difficulty: Opponent's Presence, Success: Defender armor) |
| --- |
| A daunting attacks shows how superior you are to your opponent by making flashy moves, intimidating or taunting your opponent. Awe opponents hesitate giving you some time to strike and catch your breath to recover lost resources. |
| |
...
| --- |
| Exhaust an opponent with chaotic strikes involving bare fist, pummel and shield. The goal of a scuffle attack is to reduced the opponent's resources. |
| |
...
| --- |
| Tactician tries to control the battlefield by force an opponent to make a mistake and end up in a bad position.  |
| |
| *Break:* You can break your engagement against one opponent | 
...
Even if it is the opponents turn, characters can be active by hindering an attack or defending against an attack.
...
A character can spend an action to either parry, block or dodge an attack that is directed against him. The player rolls a single Competence die against the expertise of the attack. If the roll is successful, the number of successes of the attacker is reduced by one. Only a single defensive action can be taken against an offensive maneuver.
...
The combat takes place in an old barn and the character have interest in taking advantage of the battlefield features.

On the far end of the barn there is an old ladder to access what used to be a second floor. While the floor board have mostly fallen, the beam seems solid enough to walk on it. On the left there is a pile of old straw ballot that smells old humidity but can give someone higher ground. On the right there are old rusty tools and a wheel less broken cart that could provide cover. Below the hole in the roof, there is a patch of slippery mud that is sure to hinder any combatant fighting in that area.
...
Harpies are the demons that invaded the Dryad forest and spread into the human kingdom after they fall. They are winged women with sharp talons and their body are covered in thick feathers. There should be one harpy per two characters to have a balanced challenge.

##### Styrge

Styrges are bald, skinny harpies with white skin and red eyes. Their feathers reek death and make sick opponents that would get to close. Styrges are said to drink the blood of their victim and reap their soul before dying to continue feeding on them even in the afterlife.

The styrge is armed with a club and will fight in close combat without hesitation with its stench sickening her opponents. If the styrge loses Health, she will not hesitate to attack a defenseless opponent if she can to suck their blood to heal their own wound.

| Styrge           |       |               |       |            |       |               |       |            |       |
| ---------------- | :---: | ------------- | :---: | ---------- | :---: | ------------- | :---: | ---------- | :---: |
| Hit Points       |  9/18 | Energy Points |  6/4  | Position   |   4   |               |       |            |       |
| Combat           |  3/3  | Daunt         |  2/1  | Feint      |  2/2  | Scuffle       |  3/3  | Tactics    |  -/1  |
| Armor            | 3/1d8 | Shield        |   -   | Weapon     |   1   | Dodge         |   3   |            |       |

| Abilities     |          |                                                                                                            |
| ------------- | -------- | ---------------------------------------------------------------------------------------------------------- |
| Club          | Weapon   | Melee, grade 1.                                                                                            |
| Talons        | Weapon   | Hand-to-Hand, grade 0.                                                                                     |
| Blod drain    | Success  | On an attack that reduced Health, the styrge regain the same number of Health than its opponent have lost. |
| Death stench  | Trigger  | When an opponent engage a styrge, the styrge make a free scuffle attack against the opponent. If the atack is successful, the opponent is at disadvantage for as long as he stay engage with the styrge.                      |
...
During the combat, the siren will fly near the roof avoiding close combat if she can. Only character with range attack or that position themselves on a beam can attack her while flying. The siren prefer dealing no damage with their shriek attack in order to use her lure ability to send a character into the mud patch or mesmerized them so they could not take defensive action against the other harpies.

| Siren         |       |               |       |            |       |               |       |            |       |
| ------------- | :---: | ------------- | :---: | ---------- | :---: | ------------- | :---: | ---------- | :---: |
| Hit Points    |  5/14 | Energy Points | 10/7  | Position   |   3   |               |       |            |       |
| Combat        |  1/3  | Daunt         |  4/3  | Feint      |  1/2  | Scuffle       |  1/1  | Tactics    |  3/1  |
| Armor         |   -   | Shield        |   -   | Weapon     |   -   | Dodge         |   3   |            |       |

| Abilities     |          |                                                                                                        |
| ------------- | -------- | ------------------------------------------------------------------------------------------------------ |
| Shreik        | Weapon   | Missile, grade 0, Ignore armor, Weak (Base damage 1d4).                                                |
| Talons        | Weapon   | Hand-to-Hand, grade 0.                                                                                 |
| Lure          | Success  | On a shriek attack, the harpy can make the defender move into an obstacle or leave a vantage point.    |
...
| Snatcher          |       |               |       |            |       |               |       |            |       |
| ----------------- | :---: | ------------- | :---: | ---------- | :---: | ------------- | :---: | ---------- | :---: |
| Hit Points        |  6/14 | Energy Points |  7/7  | Position   |   5   |               |       |            |       |
| Combat            |  -/4  | Daunt         |  3/1  | Feint      |  3/2  | Scuffle       |  3/-  | Tactics    |  1/3  |
| Armor             | 3/1d8 | Shield        |   -   | Weapon     |   0   | Dodge         |   4   |            |       |

| Abilities     |          |                                                                                                                        |
| ------------- | -------- | ---------------------------------------------------------------------------------------------------------------------- |
| Talons        | Weapon   | Hand-to-Hand, grade 0, Grab.                                                                                           |
| Grab          | Success  | A grab opponent is force to fight hand-to-hand even if he have initiative. A grab can be broken with a Scuffle attack. |
| Rake          | Success  | Against a grabbed opponent, a snatcher can add damage dice instead of taking the highest die.                          |
| Snatch        | Success  | Disarm an opponent weapon or shield (Action to recover).                                                               |
