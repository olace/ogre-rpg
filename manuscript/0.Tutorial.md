...
| Abilities    |         |                                                                                                |
| ------------ | ------- | ---------------------------------------------------------------------------------------------- |
| Battle axe   | Weapon  | Melee: An opponent with hand-to-hand weapon have disadvantage on damage if Belur has initiative.<br>Reach: Belur can make a close quarter attack without engaging the opponent first.              |
