...
| -  | --------- |
| 4  | Advantage |
| 5  | No advantage or disadvantage<br>Both advantage and disadvantage |
| 6  | Advantage |
...
| --- |
| The characters tries to hide in the forest behind whatever they can find: trees, bushes or rocks.<br><br>Failure: The Ogre see one of the character that failed his maneuver. Before the Ogre even start moving toward the group, Yarim goes out of hiding to distract the Ogre and yell to the characters to flee deeper in the forest. Yarim survives his encounter with the Ogre and join back the group after a few minutes. Unfortunately, he was seriously wounded by the Ogre and Yarim will not be able to help the characters in the following challenges. |
...
| --- |
| The nature competence can be used to find a nice place in the forest where the group will be able to sleep on soft ground.<br><br>Failure: Weariness strains. |

| **Build a camp (Competence: Craft, Difficulty: 3, success: 1d8)** |
| --- |
| The character can use woods and leaves to build a small shelter where people will be able to rest peacefully.<br><br>Failure: Weariness strains. |
...
| --- |
| The character goes hunting small animal in the forest. The characters won't eat raw meat so a fire must be build (a craft maneuver) and an action must be spend to prepare and cook the meat.<br><br>Failure: Hunger strains. |

| **Gathering (Competence: Nature, Difficulty: 3, success: 1d6)** |
| --- |
| The character goes fruit picking and will bring berries and apple to the group.<br><br>Failure: Hunger strains. |
...
| --- |
| The character rub two sticks together in order to start a fire. An action will be needed to fetch enough woods for the night.<br><br>Failure: Cold strains. |

| **Find a natural shelter (Competence: Nature, Difficulty: 3, success: 1d6)** |
| --- |
| The nature competence can be used to find a burrow where the group will be protected from the cold wind.<br><br>Failure: Cold strains. |
...
| **Hunting/Fishing (Competence: Animal)<br>Liddle forest (Difficulty: 2, Success: 1d8)<br>Usha river (Difficulty: 1, Success: 1d6)<br>Amun plain (Difficulty: 3, Succes: 1d4)** |
| --- |
| The character goes hunting small animal or goes fishing in the Usha river. The characters won't eat raw meat so a fire must be build (a craft maneuver with difficulty 2 in all zone) and an action must be spend to prepare and cook the meat.<br><br>Failure: Hunger strains. |

| **Gathering (Competence: Nature)<br>Liddle forest (Difficulty: 3, Success: 1d6)<br>Usha river (Difficulty: 3, Success: 1d4)<br>Amun plain (Difficulty: 1, Success: 1d8)** |
| --- |
| The character goes fruit picking and will bring berries and apple to the group.<br><br>Failure: Hunger strains. |
...
| --- |
| While in Liddle forest, the nature competence can be used to fell trees on the road used by the ogres. Even if the ogres are very strong, they will need some time to clear the road.<br><br>Failure: The ogres will reach Amun in one less hour. |

| **Collapsing the bridge (Competence: Sabotage, Difficulty: 2)** |
| --- |
| The Usha river bridge is old and made of wood. It can easily support a few man crossing it at the same time, but the ogres are massive. By weakening the bridge, a clever character can arrange the bridge so that it will collapse under the ogres weight.<br><br>Failure: The ogres will reach Amun in one less hour. |
...
| Combat Effect |
| *Critical hit:* Increase all success die used to incapacitate an opponent by one step.<br>*Disadvantage:* Foe is at disadvantage against next attack or for its next attack. |
...
| Combat Effect |
| *Regain defense:* Recover lost defense as indicate on the character sheet.<br>*Regain fatigue:* Recover lost fatigue as indicate on the character sheet. |
...
| Combat Effect |
| *Action:* Get an extra action.<br>*Initiative:* Gain initiative if you do not have it.<br>*Position:* Get an extra position point. |
...
| Combat Effect |
| *Disorient:* Opponent lose an action<br>*Initiative:* Opponent lose initiative if he has it<br>*Position:* Opponent lose a position point |
...
| Combat Effect |
| *Break engagement:* You can break your engagement against one opponent <br>*Dislodge an opponent:* Remove an opponent from a vantage point<br>*Activate obstacle*: Activate an obstacle upon the opponent |
...
| ---------- | ---------- | ---------- | ---------- | ---------- |
| Aminha     | Jinn       | Nomad      | Warrior    | Ascetic    |
...
| Resources  |     |               |     |            |     |
| ---------  | --- | ---------     | --- | ---------  | --- |
| Defense    |  6  | Fatigue       |  6  | Position   |  4  |
| Health     |  9  | Exhaustion    |  3  | Load       |  9  |
...
| Combat     |     |               |     |            |     |               |     |               |     |
| ---------  | --- | ---------     | --- | ---------  | --- | --------      | --- | --------      | --- |
| Combat     |  2  | Daunt         |  1  | Feint      |  -  | Scuffle       |  3  | Trick         |  2  |
| Reflex     |  2  | Presence      |  -  | Awareness  |  1  | Stamina       |  3  | Intelligence  |  2  |
| Armor      |  -  | Block         |  -  | Dodge      |  1  | Parry         |  1  |

| Equipment  |     |        |                         |
| -----      | --- | -----  | ---------------------   |
| Stone Fist |  1  | Weapon | Melee: 1d6.             |
...
| Name       | Race    | Culture     | Vocation   | Profession |
| ---------- | ---------- | ----------  | ---------- | ---------- |
| Belur      | Dvegar     | Underground | Warrior    | Soldier    |
...
|            |     |               |     |            |     |
| ---------  | --- | ---------     | --- | ---------  | --- |
| Defense    |  4  | Fatigue       |  -  | Position   |  3  |
| Health     |  9  | Exhaustion    |  6  | Load       |  9  |
...
| Combat     |     |               |     |            |     |               |     |               |     |
| ---------  | --- | ---------     | --- | ---------  | --- | --------      | --- | --------      | --- |
| Combat     |  3  | Daunt         |  1  | Feint      |  -  | Scuffle       |  3  | Trick         |  -  |
| Reflex     |  1  | Presence      |  3  | Awareness  |  -  | Stamina       |  3  | Intelligence  |  -  |
| Armor      |  3  | Block         |  3  | Dodge      |  1  | Parry         |  3  |

| Equipment |     |        |                         |
| -----     | --- | -----  | ---------------------   |
| Axe       |  3  | Weapon | Melee: 1d8.             |
| Chain     |  3  | Armor  |                         |
| Shield    |  3  | Shield |                         |
...
| Resources  |     |             |     |            |     |
| ---------  | --- | ---------   | --- | ---------  | --- |
| Defense    |  6  | Fatigue     |  3  | Position   |  5  |
| Health     |  3  | Exhaustion  |  9  | Load       |  3  |
...
| Combat     |     |               |     |            |     |               |     |               |     |
| ---------  | --- | ---------     | --- | ---------  | --- | --------      | --- | --------      | --- |
| Combat     |  3  | Daunt         |  3  | Feint      |  -  | Scuffle       |  1  | Trick         |  1  |
| Reflex     |  2  | Presence      |  3  | Awareness  |  2  | Stamina       |  -  | Intelligence  |  1  |
| Armor      |  1  | Block         |  -  | Dodge      |  -  | Parry         |  3  |

| Equipment    |     |        |                         |
| -----        | --- | -----  | ---------------------   |
| Sword        |  3  | Weapon | Melee: 1d8.             |
| Cuir bouilli |  1  | Weapon | Range: 1d8. Range       |
...
| Resources  |     |               |     |            |     |
| ---------  | --- | ---------     | --- | ---------  | --- |
| Defense    |  4  | Fatigue       |  6  | Position   |  6  |
| Health     |  4  | Exhaustion    |  4  | Load       |  4  |
...
| Combat     |     |               |     |            |     |               |     |               |     |
| ---------  | --- | ---------     | --- | ---------  | --- | --------      | --- | --------      | --- |
| Combat     |  2  | Daunt         |  1  | Feint      |  2  | Scuffle       |  1  | Trick         |  2  |
| Reflex     |  1  | Presence      |  1  | Awareness  |  3  | Stamina       |  1  | Intelligence  |  2  |
| Armor      |  -  | Block         |  -  | Dodge      |  2  | Parry         |  1  |

| Equipment |     |        |                         |
| -----     | --- | -----  | ---------------------   |
| Staff     |  1  | Weapon | Melee: 1d10. 2-handed   |
...
| Name       | Race       | Culture     | Vocation   | Profession |
| ---------- | ---------- | ----------  | ---------- | ---------- |
| Karasu     | Tengu      | Sylvan      | Strategist | Archer     |
...
| Resources  |     |               |     |            |     |
| ---------  | --- | ---------     | --- | ---------  | --- |
| Defense    |  6  | Fatigue       |  6  | Position   |  6  |
| Health     |  4  | Exhaustion    |  3  | Load       |  4  |
...
| Combat     |     |               |     |            |     |               |     |               |     |
| ---------  | --- | ---------     | --- | ---------  | --- | --------      | --- | --------      | --- |
| Combat     |  3  | Daunt         |  -  | Feint      |  3  | Scuffle       |  2  | Trick         |  2  |
| Reflex     |  2  | Presence      |  -  | Awareness  |  3  | Stamina       |  1  | Intelligence  |  2  |
| Armor      |  -  | Block         |  -  | Dodge      |  3  | Parry         |  2  |

| Equipment |     |        |                         |
| -----     | --- | -----  | ---------------------   |
| Sword     |  2  | Weapon | Melee: 1d8.             |
| Bow       |  1  | Weapon | Range: 1d8. Range       |
...
### Manasa the Naga thief

| Name       | Race       | Culture     | Vocation     | Profession |
| ---------- | ---------- | ----------  | ----------   | ---------- |
| Manasa     | Naga       | Slave       | Swashbuckler | Thief      |
...
| Resources  |     |               |     |            |     |
| ---------  | --- | ---------     | --- | ---------  | --- |
| Defense    |  9  | Fatigue       |  9  | Position   |  3  |
| Health     |  3  | Exhaustion    |  6  | Load       |  3  |
...
| Combat     |     |               |     |            |     |               |     |               |     |
| ---------  | --- | ---------     | --- | ---------  | --- | --------      | --- | --------      | --- |
| Combat     |  3  | Daunt         |  -  | Feint      |  3  | Scuffle       |  3  | Trick         |  3  |
| Reflex     |  3  | Presence      |  2  | Awareness  |  -  | Stamina       |  -  | Intelligence  |  3  |
| Armor      |  1  | Block         |  -  | Dodge      |  2  | Parry         |  2  |

| Equipment |     |        |                        |
| -----     | --- | ------ | ---------------------  |
| Sword     |  1  | Weapon | Base damage: 1d8.      |
